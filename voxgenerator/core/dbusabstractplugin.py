...
class DbusAbstractPlugin(dbus.service.Object):
    def __init__(self):
        ...
        self.__dbus_path__      = '/org/freedesktop/Voxgenerator'
    ...
    def __finalizeinit__(self):
        if self.__availablebus__.has_key(self.__type__):
            ...
            busName = dbus.service.BusName('org.freedesktop.Voxgenerator.' + self.__name__, self.__bus__)
        else:
            busName = dbus.service.BusName('org.freedesktop.Voxgenerator.' + self.__name__, dbus.SessionBus())
    ...
    def __run__(self):
        ...
        try:
            ...
            self.__logger__.info(self.__name__ + " has been stopped !")
